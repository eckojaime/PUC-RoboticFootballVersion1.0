...
class TheServer implements ActionListener
{
   ...
   public void setUpMenuBar()
   {
       ...
       JMenu serverPort = new JMenu("Server Port");
       ...
       servPort = new JMenuItem(Integer.toString(ServerPort));
       
       JMenuItem aboutDetails = new JMenuItem("Implemented in Spring 2014");
   ...
   public void actionPerformed(ActionEvent e)
   {
	   if(controllersAreFound)
	   {
		   if(e.getActionCommand().equals(btnStart.getText()))
		   {
			   if(!isRunning)
			   {
                   ...
                   QBSend = new ProcessUserInput("Player 1", null, RobotIPs[0], RobotPorts[0], QB, RC);
	    	          //QBReceive = new ProcessRobotPosition("Player 1", foundControllers.get(0), ServerIP, ServerPort, QB);
                   ...
                   RCSend = new ProcessUserInput("Player 2", null, RobotIPs[1], RobotPorts[1], QB, RC);
	    	    	    //RCReceive = new ProcessRobotPosition("Player 2", foundControllers.get(1), ServerIP, ServerPort, RC);
		   ...
		   else if(e.getActionCommand().equals(btnStop.getText()))
		   {
               ...
               {
                  appState.setText(ex.getMessage());
      ...
      if(e.getActionCommand().equals(menuEditBtn.getText()))
      {
         if(!menuSubmitBtn.isEnabled())
         {
            ...
            System.out.println("Edit is clicked and Enabled");
         }
