		   ...
		   if(e.getActionCommand().equals(btnStart.getText()))
		   {
			   if(!isRunning)
			   {
	    	       ...
	    	       if(playerOneIsConnected)
	    	       {
	    	          ...
	    	          QBReceive = new ProcessRobotPosition("Player 1", foundControllers.get(0), ServerIP, ServerPorts[0], QB);
	    	       ...
	    	       if(playerTwoIsConnected)
	    	       {
	    	    	   ...
	    	    	   //RCReceive = new ProcessRobotPosition("Player 2", foundControllers.get(1), ServerIP, ServerPorts[1], RC);
